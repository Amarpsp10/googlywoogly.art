...
export function Footer({
  ...
  /** Real catalog categories for the Categories column (links to /category/[slug]). */
    ...
    <footer className="bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          {/* Categories — real catalog categories (links to /category/[slug]). */}
          <div>
        ...
        <div className="border-t border-background/10 pt-8">
          {/* Policy / help links (real pages) — required for a real store footer. */}
          <ul className="mb-6 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-background/70">
            {[
              ...
              <li key={link.href}>
                <Link href={link.href} className="hover:text-pastel-mint transition-colors">
                  {link.name}
                </Link>
              </li>
            ))}
