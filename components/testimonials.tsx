...
const testimonials = [
  {
    ...
    location: "Mumbai",
    rating: 5,
    text: "Absolutely loved the personalized gift I ordered for my husband's birthday! The attention to detail was incredible.",
    product: "Custom Portrait Frame",
    avatar: "PS",
    color: "#FFB3C6",
  },
  {
    ...
    location: "Delhi",
    rating: 5,
    text: "The scrapbook I got for my girlfriend was simply beautiful! She was in tears of joy. Thank you!",
    product: "Memory Scrapbook",
    avatar: "RV",
    color: "#B8F4D0",
  },
  {
    ...
    location: "Bangalore",
    rating: 5,
    text: "Fast delivery, excellent quality, and the packaging was so pretty! Perfect for my friend's wedding.",
  ...
  },
  {
    ...
    location: "Pune",
    rating: 5,
    text: "I've ordered multiple times and the quality has been consistently amazing. Highly recommended!",
    product: "Customized Wall Art",
    avatar: "VS",
    color: "#E0C6FF",
  },
  {
    ...
    location: "Jaipur",
    rating: 5,
    text: "The birthday hamper was beautifully curated. The personalized touch made all the difference.",
    product: "Birthday Hamper",
    avatar: "SG",
    color: "#FFCBA4",
  },
  {
    ...
    location: "Hyderabad",
    rating: 5,
    text: "Exceptional work! The coasters I ordered were stunning. Everyone at the party loved them!",
    product: "Hand-painted Coasters",
    avatar: "AR",
    color: "#A8E6FF",
  },
];
...
const TestimonialCard = ({
  ...
  <div
    ...
    style={{
      background: `linear-gradient(135deg, white, ${testimonial.color}10)`,
    }}
  >
    {/* Quote Icon */}
    <Quote
      className="w-8 h-8 mb-4"
      style={{ color: `${testimonial.color}80` }}
    />
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="relative overflow-x-hidden py-4">
          <motion.div
            className="flex"
            initial={{ x: -50 * testimonials.length * 6.5 }}
            animate={{ x: 0 }}
            transition={{
              duration: 45,
              repeat: Infinity,
            ...
            <div className="text-left">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-4 h-4 fill-[#FFE566] text-[#FFE566]"
                  />
                ))}
              </div>
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">100+</strong> Happy
                Customers
              </p>
            </div>
          </div>
