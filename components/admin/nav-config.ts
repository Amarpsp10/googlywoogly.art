...
export const ADMIN_NAV: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Banners", href: "/admin/content/banners", icon: GalleryHorizontalEnd, roles: NON_STAFF },
      { label: "Testimonials", href: "/admin/content/testimonials", icon: Quote, roles: NON_STAFF },
      { label: "FAQ", href: "/admin/content/faq", icon: HelpCircle, roles: NON_STAFF },
      { label: "Pages", href: "/admin/content/pages", icon: FileText, roles: NON_STAFF },
